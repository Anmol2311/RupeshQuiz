...
export class UpdateAdminComponent implements OnInit {
  ...
  update(frm) {
    ...
    this._http.post("http://localhost/quiz_api/updateAdmin.php", this.resObj, { responseType: 'text' }).subscribe(
      () => {
  ...
  ngOnInit() {
    ...
    this._http.post<Admin[]>("http://localhost/quiz_api/selectSingleAdmin.php", { 'admID': this.id }).subscribe(
      (res) => {
        this.data = res;
